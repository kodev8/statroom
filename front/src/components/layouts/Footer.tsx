...
const Footer = () => {
    const newsLetterForm = useForm<TEmailSchema>({
    ...
    const newsLetterMutation = useMutation({
        mutationFn: async (data: TEmailSchema) => {
            return await axiosInstance.post('/api/newsletter', data);
        },
        onSuccess: () => {
            toast({
                variant: 'success',
        ...
        <section className="py-10 bg-gray-50 sm:pt-16 lg:pt-24 dark:bg-black">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                        ...
                        <ul className="flex items-center space-x-3 mt-9">
                            <li>
                                <Link
                                    to="#"
                                    title=""
                                    className="flex items-center justify-center text-white dark:text-gray-800 transition-all duration-200 bg-gray-800 dark:bg-white rounded-full w-7 h-7 hover:bg-slate-200 focus:bg-slate-200"
                                >
                                    <svg
                                        className="w-4 h-4"
                            ...
                            <li>
                                <Link
                                    to="#"
                                    title=""
                                    className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-slate-200 focus:bg-slate-200"
                                >
                                    <svg
                                        className="w-4 h-4"
                                        xmlns="http://www.w3.org/2000/svg"
                ...
                <p className="text-sm text-center text-gray-600">
                    © Copyright 2024, All Rights Reserved by StatRoomAI
                </p>
            </div>
        </section>
    );
