                ...
                >
                    ...
                    {enableDeselect && (
                        <Button
                            ...
                            onClick={(e) => {
                                e.stopPropagation();
                                if(onClickDeselect) onClickDeselect();
                            }}
                        >
                            <span className="relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 text-sm outline-none focus:bg-slate-100 focus:text-slate-900 ">
                                Deselect
                            </span>
                        </Button>
                    )}
