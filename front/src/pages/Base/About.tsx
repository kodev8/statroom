            ...
            <div className="container">
                ...
                <div className="mx-auto flex max-w-5xl flex-col items-center ">
                    <div className="z-10 flex flex-col items-center gap-6 text-center">
                        <Badge variant="outline">StatRoom AI</Badge>
                        <div>
                            <h1 className="mb-6 text-pretty text-2xl font-bold lg:text-5xl">
                                Harness the Power of Sports Data!
                            </h1>
                            <p className="text-muted-foreground lg:text-xl">
                                Dive into cutting-edge sports analytics and
                                uncover trends that give you the edge. Explore
                                our insights today!
                            </p>
                        </div>
